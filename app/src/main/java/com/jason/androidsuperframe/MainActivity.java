...
//        StatusBarUtil.setTransparentForDrawerLayout(this,drawer);
        StatusBarUtil.setColorForDrawerLayout(this, drawer, 0x00ffff, 0);
    ...
    public void switchContent(Fragment to) {
        if (mCurrentFragment != to) {
            ...
            if (!to.isAdded()) { // 先判断是否被add过
                transaction.hide(mCurrentFragment).add(R.id.content_layout, to).commit(); // 隐藏当前的fragment，add下一个到Activity中
            } else {
